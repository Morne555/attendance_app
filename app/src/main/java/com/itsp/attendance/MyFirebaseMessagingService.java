...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(final RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getNotification() != null) {
            ...
            handler.post(new Runnable() {
                public void run() {
                    String message = remoteMessage.getNotification().getTitle() + " attended";
                    ...
                    SaveNotification sn = new SaveNotification(remoteMessage.getNotification().getTitle(), remoteMessage.getNotification().getBody());
                    sn.execute();
                }
            });
        }
    ...
    private void sendRegistrationToServer(String token) {
        // TODO(Morne): Implement this method to send token to your app server.
    }
